...
<div class="section-menu mt-4 chckpagg">
	<div class="container">
	  <div class="row">
	<?php
...
<div class="container mt-0 mt-lg-5" >
  ...
  <section id="section-address" class="mb-4 p-2 p-lg-0">
   <div class="row">
    <div class="col-lg-12 col-md-12 p-0 mb-12 mb-lg-0">
        <div class="d-flex">
	...
	<div class="d-flex">
		<div class="mr-3"><img class="img-20" src="<?php echo Yii::app()->theme->baseUrl."/assets/images/clock.png"?>"/></div>
			<div class="flex-fill">
				<h5><?php echo t("Opening hours")?>:</h5>
				<table style="width:100%;max-width:100%;" class="adrs-filds">
					<thead>
						<tr>
							<th class="align-top pb-1">Day</th>
							<th class="bold align-top pb-1"><p class="m-0">Take Away</p></th>
							<th class="bold align-top pb-1"><p class="m-0">Delivery</p></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="align-top pb-1">Monday</td>
							<td class="bold align-top pb-1"><p class="m-0"> 12:15 PM - 9:45 PM </p></td>
							<td class="bold align-top pb-1"><p class="m-0"> 03:45 PM - 9:00 PM </p></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="bold align-top pb-1"><p class="m-0"> 12:15 PM - 9:40 PM </p></td>
							<td class="bold align-top pb-1"><p class="m-0"> 02:00 PM - 9:00 PM </p></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="bold align-top pb-1"><p class="m-0"> 12:15 PM - 9:55 PM </p></td>
							<td class="bold align-top pb-1"><p class="m-0"> 02:00 PM - 9:00 PM </p></td>
						</tr>
						<tr>
