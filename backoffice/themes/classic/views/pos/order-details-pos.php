   ...
   <DIV class="pos-order-details nice-scroll p-2 pb-0">
    ...
    <div class="row" >
     ...
     <div class="col-5 d-flex justify-content-start flex-column">
	     ...
	     <p class="mb-1">
	     <!-- {{items.qty}}x -->
	     <!-- <p v-html="items.item_name">{{ items.item_name }} </p> -->
       <p v-html="items.item_name"></p>
...
<div ref="submit_order_modal" class="modal" tabindex="-1" role="dialog" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer border-0">
          <!--<button type="button" @click="submitOrder" class="btn btn-green pl-4 pr-4 print-receipt" :class="{ loading: create_payment_loading }"
